...
- **Студент:** Малышев Михаил 
- **Группа:** ПИ-430Б
- **Дата выполнения:** 27.12.2025
...
curl -s -w "\nHTTP Status: %{http_code}\n" "$TARGET_URL" >> /home/Mihail/cron_requests.log 2>&1
echo "[$(date '+%Y-%m-%d %H:%M:%S')] Request sent to $TARGET_URL" >> /home/Mihail/cron_requests.log
exit 0

```

*(Скриншот 1: Содержимое скрипта send_request.sh)*
<img width="1000" height="219" alt="image" src="https://github.com/user-attachments/assets/9faf895c-3267-4569-9891-7898765bbf99" />
...
```
*/5 * * * * /home/Mihail/cron_scripts/send_request.sh
```
...
<img width="777" height="592" alt="image" src="https://github.com/user-attachments/assets/5a0ac0c2-ccb5-4677-9eeb-5eec3be0ea11" />
